...
const opportunityFields = [
  ...
  text("NTE_Logistics_Contact_Name__c", "NTE Logistics Contact Name", 200),
  email("NTE_Logistics_Contact_Email__c", "NTE Logistics Contact Email"),
  phone("NTE_Logistics_Contact_Phone__c", "NTE Logistics Contact Phone"),
  text("NTE_Logistics_Second_Contact_Name__c", "NTE Logistics Second Contact Name", 200),
  email("NTE_Logistics_Second_Contact_Email__c", "NTE Logistics Second Contact Email"),
  phone("NTE_Logistics_Second_Contact_Phone__c", "NTE Logistics Second Contact Phone"),
...
for (const field of opportunityFields) {
  ...
  if (field.api.startsWith("NTE_Logistics_Second_Contact_")) field.description = "Second contact supplied on the most recent Heavy Vehicle Details submission. Replaced automatically when a later submission is applied.";
  else if (field.api.startsWith("NTE_Logistics_Contact_")) field.description = "Main contact supplied on the most recent Heavy Vehicle Details submission. Replaced automatically when a later submission is applied.";
...
const bookingLogistics = opportunitySections.find(section => section.label === "Heavy vehicle and logistics");
const logisticsContactFields = bookingLogistics.fields.filter(field => field.startsWith("NTE_Logistics_"));
bookingLogistics.fields = bookingLogistics.fields.filter(field => !logisticsContactFields.includes(field));
opportunitySections.splice(opportunitySections.indexOf(bookingLogistics), 0, {
  label: "Logistics contacts", fields: logisticsContactFields,
  columns: [logisticsContactFields.filter(field => !field.includes("Second_")), logisticsContactFields.filter(field => field.includes("Second_"))]
});
