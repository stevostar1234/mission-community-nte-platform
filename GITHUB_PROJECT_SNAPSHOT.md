...
16 September: the additional [EOI webinar invitation](output/NTE27-Webinar-Invitations/eoi-webinar-invitation.html) uses the Classic Contact first-name merge, with exact supplied wording and native merge verification. The original three emails and all qualified Salesforce source remain unchanged. [Release](audit/NTE_EOI_WEBINAR_INVITATION_2026-09-16.md).
