...
export default class NteMasterPanel extends NavigationMixin(LightningElement) {
    ...
    decorateRow(row, selectedId) {
        ...
        return {
            ...
            hasLogisticsContacts: isOpportunity && Boolean(row.logisticsContactName || row.logisticsContactEmail || row.logisticsContactPhone
                || row.logisticsSecondContactName || row.logisticsSecondContactEmail || row.logisticsSecondContactPhone),
            logisticsContactNameDisplay: row.logisticsContactName || 'Not supplied',
            logisticsContactEmailUrl: row.logisticsContactEmail ? `mailto:${row.logisticsContactEmail}` : null,
            logisticsContactPhoneUrl: row.logisticsContactPhone ? `tel:${row.logisticsContactPhone.replace(/\s/g, '')}` : null,
            logisticsSecondContactNameDisplay: row.logisticsSecondContactName || 'Not supplied',
            logisticsSecondContactEmailUrl: row.logisticsSecondContactEmail ? `mailto:${row.logisticsSecondContactEmail}` : null,
            logisticsSecondContactPhoneUrl: row.logisticsSecondContactPhone ? `tel:${row.logisticsSecondContactPhone.replace(/\s/g, '')}` : null,
